...
export const FeaturesSection = () => {
  ...
  return (
    <div className="bg-[#EFEFEF] relative overflow-hidden">
      ...
      <motion.img 
        className="absolute right-0 top-0 w-[700px] h-[full] object-cover" 
        src="https://greeny.axiomthemes.com/wp-content/uploads/2022/03/home2-image1.jpg" 
        alt=""
        initial={{ opacity: 0, x: 50 }}
        whileInView={{ opacity: 1, x: 0 }}
        viewport={{ once: true, margin: "-100px" }}
