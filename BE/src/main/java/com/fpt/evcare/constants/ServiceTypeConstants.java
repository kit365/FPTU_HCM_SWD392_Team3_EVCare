...
public class ServiceTypeConstants {
    ...
    public static final String MESSAGE_ERR_CHOOSING_NOT_SPECIFIC_SERVICE_TYPE  = "Vui lòng chọn loại dịch vụ cụ thể";
    ...
    public static final String LOG_ERR_CHOOSING_NOT_SPECIFIC_SERVICE_TYPE  = "Vui lòng chọn loại dịch vụ cụ thể: {}";
    public static final String LOG_ERR_CAN_NOT_DELETE_SERVICE_TYPE = "Có cuộc hẹn đang sử dụng loại dịch vụ này, không thể xóa: {}";
    public static final String LOG_ERR_CAN_NOT_DELETE_PARENT_SERVICE_TYPE= "Không thể xóa loại dịch vụ cha: {}";
