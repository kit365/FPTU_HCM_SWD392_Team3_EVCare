...
public interface AppointmentMapper {
    ...
    @Mapping(target = "serviceTypeEntities", ignore = true)
    @Mapping(target = "assignee", ignore = true)
    @Mapping(target = "technicianEntities", ignore = true)
    @Mapping(target = "serviceMode", ignore = true)
    @Mapping(target = "status", ignore = true)
    @Mapping(target = "search", ignore = true)
    @Mapping(target = "quotePrice", ignore = true)
    @Mapping(target = "vehicleTypeEntity", ignore = true)
    void toUpdateForAdmin(@MappingTarget AppointmentEntity appointmentEntity, UpdationAppointmentRequest updationAppointmentRequest);
    ...
    @Mapping(target = "quotePrice", ignore = true)
    @Mapping(target = "vehicleTypeEntity", ignore = true)
    void toUpdateForCustomer(@MappingTarget AppointmentEntity appointmentEntity, UpdationCustomerAppointmentRequest updationCustomerAppointmentRequest);
}
